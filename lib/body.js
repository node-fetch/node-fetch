...
Body._clone = function(source, destination) {

    // reassign the body
    destination.body = source.body;

    // reassign whatever has been decoded by this moment
    destination._raw = [].concat(source._raw);
    destination._bytes = source._bytes;
